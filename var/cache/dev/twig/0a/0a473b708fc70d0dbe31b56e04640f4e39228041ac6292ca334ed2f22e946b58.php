...
class __TwigTemplate_6262b1ddbcb697d4c4fc94730f7f50201aa7edd5ce46af51b4d5ae3b84bab3b8 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <section class=\"signup\">
        ...
        echo "
                    ...
                    <div class=\"form-group\">
                        ";
        // line 23
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 23, $this->source); })()), "confirm_password", [], "any", false, false, false, 23), 'row');
        echo "
                    </div>
...
";
    ...
    {
        return array (  119 => 37,  102 => 23,  96 => 20,  90 => 17,  84 => 14,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{{ form_end(form) }}
{% endblock %}
", "user/index.html.twig", "/home/weijie/MVC_My_Quiz/quiz/templates/user/index.html.twig");
    }
}
