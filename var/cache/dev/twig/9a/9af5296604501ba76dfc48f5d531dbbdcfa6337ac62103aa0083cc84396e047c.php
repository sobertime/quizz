...
class __TwigTemplate_9bf0b346280b2b65133edc7a4a44110df980fd5ed26d16d529f492c2fe114729 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ( !twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 6, $this->source); })()), "user", [], "any", false, false, false, 6)) {
            // line 7
            echo "<h2> You're not connected ! </h2>
";
        } else {
            // line 9
  ...
  <a href=\"";
            ...
            echo "\" class=\"btn btn-primary\" style=\"margin-top: 50%;\">Editer</a>
  <a href=\"";
            // line 13
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("logout");
            echo "\" class=\"btn btn-danger\" style=\"margin-top: 50%;\">Logout</a>
</div>
";
        }
        // line 16
...
";
    ...
    {
        return array (  100 => 16,  94 => 13,  90 => 12,  86 => 11,  82 => 10,  79 => 9,  75 => 7,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{% else %}
<div class=\"profil\">
  <h3 class=\"p_username\">{{ app.user.username }}</h2>
  <p class=\"p_mail\">{{ app.user.email }}</p>
  <a href=\"{{ path('edit') }}\" class=\"btn btn-primary\" style=\"margin-top: 50%;\">Editer</a>
  <a href=\"{{ path('logout') }}\" class=\"btn btn-danger\" style=\"margin-top: 50%;\">Logout</a>
</div>
{% endif %}

{% endblock %}
", "user/profil.html.twig", "/home/weijie/MVC_My_Quiz/quiz/templates/user/profil.html.twig");
    }
}
